...
.method private drawMainJpeg(Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;Z)Z
    ...
    .line 295
    .local v16, jpeg:Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;
    const/4 v15, 0x1

    .line 296
    .local v15, downScale:I
    ...
    iget v1, v0, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mHeight:I
    ...
    iget v2, v0, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mPreviewWidth:I
    ...
    .line 313
    .local v19, render:Lcom/android/camera/effect/renders/Render;
    ...
    invoke-static {v1, v2, v15}, Lcom/android/camera/effect/ShaderNativeUtil;->initTexture([BII)[I
    ...
    iget v1, v0, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mPreviewWidth:I

    move-object/from16 v0, v16

    iget v2, v0, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mPreviewHeight:I
    ...
    iget v6, v0, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mHeight:I
    ...
    iput-object v14, v0, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mData:[B
    ...
    invoke-virtual {v1, v2}, Lcom/android/camera/effect/EffectController;->addWeight(I)V
    ...
    iget v11, v0, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mJpegOrientation:I

    const/4 v12, 0x0

    const/4 v13, 0x0

    invoke-virtual/range {v1 .. v13}, Lcom/android/camera/storage/ImageSaver;->addImage([BLjava/lang/String;JLandroid/net/Uri;Landroid/location/Location;IILcom/android/gallery3d/exif/ExifInterface;IZZ)V
